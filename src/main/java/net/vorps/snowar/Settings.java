...
public class Settings {
    ...
    public Settings(ResultSet result) throws SqlException{
        this.valueBoolean = Database.SNOWAR.getDatabase().getBoolean(result, 2);
        this.valueInt     = Database.SNOWAR.getDatabase().getInt(result, 3);
        this.message      = Database.SNOWAR.getDatabase().getString(result, 4);
        Settings.settings.put(Database.SNOWAR.getDatabase().getString(result, 1), this);
    }
    ...
    private static @Getter String  default_lang;
    ...
    public static void initSettings(){
        ...
        Settings.default_lang       =  Settings.settings.get("s_lang_default").message;
        Settings.clear();
    }
